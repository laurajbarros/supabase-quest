...
export const REGION1_CLEAR_BEATS = [
  ...
  { pause: 500 },
  // One line per badge. Short, and in the order they were earned, so the recap
  // reads as what she can now do rather than as a list of what she collected.
  'DETERMINATION — you didn\u2019t wait for the door to open.',
  'ENTREPRENEUR — you fixed a business, not just its costs.',
  'BRIDGE — you crossed into tech without a map.',
  { pause: 400 },
...
export const PRESENT_MOMENT_BEATS = [
  ...
  { pause: 500 },
  'LISTENING — you asked what clients actually needed.',
  'ORDER — you built structure where there was none.',
  'ARCHITECT — you saw seven problems wearing different hats.',
  'AI — you said the thing nobody wanted to say.',
  { pause: 500 },
